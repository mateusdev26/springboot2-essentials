...
public class AnimeService {
    private List<Anime> animes = List.of(new Anime(1L, "Dragon Ball Super"), new Anime(2L, "Dragon Ball Z"), new Anime(3L, "One Piece"), new Anime(4L, "Death Note"), new Anime(5L, "Naruto"));
